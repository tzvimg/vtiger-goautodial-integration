...
{strip}
    <div id="transferOwnershipContainer" class='modelContainer'>
        ...
        <form class="form-horizontal" id="chooseList" name="chooseList" method="post" action="index.php">
...
-->
 ...
 <div class="control-group">
 <div class="control-label">{vtranslate('LBL_CHOOSE_LIST', $MODULE)}</div>
                    <div class="controls">

<select class="chzn-select" data-validation-engine="validate[ required]" name="aaa" id="aaa">
                       <optgroup label="{vtranslate('LBL_LISTS')}">
                                {foreach $ROW as $listname}
                               		<option value="{$listname}" data-picklistvalue= '{$listname}'                                
