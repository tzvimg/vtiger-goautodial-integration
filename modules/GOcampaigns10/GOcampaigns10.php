		...
		class GOcampaigns10 extends Vtiger_CRMEntity {
			var $table_name = 'vtiger_gocampaigns10';
			var $table_index= 'gocampaigns10id';

			/**
			 * Mandatory table for supporting custom fields.
			 */
			var $customFieldTable = Array('vtiger_gocampaigns10cf', 'gocampaigns10id');

			/**
			 * Mandatory for Saving, Include tables related to this module.
			 */
			var $tab_name = Array('vtiger_crmentity', 'vtiger_gocampaigns10', 'vtiger_gocampaigns10cf');
			...
			var $tab_name_index = Array(
				...
				'vtiger_gocampaigns10' => 'gocampaigns10id',
				'vtiger_gocampaigns10cf'=>'gocampaigns10id');
			...
			var $list_fields = Array (
				...
				'campaign_name' => Array('gocampaigns10', '<entitycolumn>'),
