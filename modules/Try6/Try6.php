		...
		class ModuleName extends Vtiger_CRMEntity {
			var $table_name = 'vtiger_try6';
			var $table_index= 'try6id';

			/**
			 * Mandatory table for supporting custom fields.
			 */
			var $customFieldTable = Array('vtiger_try6cf', 'try6id');

			/**
			 * Mandatory for Saving, Include tables related to this module.
			 */
			var $tab_name = Array('vtiger_crmentity', 'vtiger_try6', 'vtiger_try6cf');
			...
			var $list_fields = Array (
				...
				'<entityfieldlabel>' => Array('try6', '<entitycolumn>'),
				'Assigned To' => Array('crmentity','smownerid')
			);
			var $list_fields_name = Array (
				/* Format: Field Label => fieldname */
				'<entityfieldlabel>' => 'campaign_name',
