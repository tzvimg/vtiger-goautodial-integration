		...
		class GOAutoDialCampaign6 extends Vtiger_CRMEntity {
			var $table_name = 'vtiger_goautodialcampaign6';
			var $table_index= 'goautodialcampaign6id';

			/**
			 * Mandatory table for supporting custom fields.
			 */
			var $customFieldTable = Array('vtiger_goautodialcampaign6cf', 'goautodialcampaign6id');

			/**
			 * Mandatory for Saving, Include tables related to this module.
			 */
			var $tab_name = Array('vtiger_crmentity', 'vtiger_goautodialcampaign6', 'vtiger_goautodialcampaign6cf');
			...
			var $tab_name_index = Array(
				...
				'vtiger_goautodialcampaign6' => 'goautodialcampaign6id',
				'vtiger_goautodialcampaign6cf'=>'goautodialcampaign6id');
			...
			var $list_fields = Array (
				...
				'campaign_name' => Array('goautodialcampaign6', '<entitycolumn>'),
			...
			*/
			...
			function save_module(){
				...
				//TODO: Handle errors.
				// bool(true) if ok. Error (string) if not.
			}
