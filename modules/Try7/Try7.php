		...
		class ModuleName extends Vtiger_CRMEntity {
			var $table_name = 'vtiger_try7';
			var $table_index= 'try7id';

			/**
			 * Mandatory table for supporting custom fields.
			 */
			var $customFieldTable = Array('vtiger_try7cf', 'try7id');

			/**
			 * Mandatory for Saving, Include tables related to this module.
			 */
			var $tab_name = Array('vtiger_crmentity', 'vtiger_try7', 'vtiger_try7cf');
			...
			var $list_fields = Array (
				...
				'campaign_name' => Array('try7', '<entitycolumn>'),
